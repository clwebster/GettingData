#CodeBook for Getting and Cleaing Data Course Project
---
title: "Codebook"
...
variables with mean() measure the mean of that feature
variables with std() measure the standard deviation.

All feature variables provided show the average value for the associated subject and activity.

Variables:
* SubjectID
  + Unique identifier for the subject involved in the study
* ActivityID
  + Unique identifier for the activity involved in the study
* ActivityDescr
  + Descriptive text associated with the ActivityID. Values include
    + "walking"
    + "walking upstairs"
    + "walking downstairs"
    + "sitting"
